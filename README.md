...
- Claude Code skills — `/spec-create`, `/spec-execute`, `/spec-status`, `/b6p-pull`, `/b6p-push`, `/b6p-audit`, `/quick-task`, `/task-comment`, `/bspecs-feedback`, `/bluestep-init`, and `/bluestep-mcp-connect` (connect an org's platform MCP)
