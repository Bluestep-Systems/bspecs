...
Context: role→staff permission-propagation formulas. Broke when a new single-select field was added; older role records had it empty. See [api patterns](api-patterns.md), [formula patterns](../conventions/formula-patterns.md).
