...
Platform orientation plus the workflow reference for sync, lifecycle, and the b6p CLI. Critical rules live in `CLAUDE.md`; on-demand detail lives in the skill index (`SKILL.md`).
