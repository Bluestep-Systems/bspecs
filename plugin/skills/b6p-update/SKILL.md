...
1. **The tool's own list of opened directories.** Read `${CLAUDE_PLUGIN_ROOT}/skills/b6p-update/references/project-index.md` for the section covering the tool you are running in — where the list lives, how to read it safely, and how complete it is.
