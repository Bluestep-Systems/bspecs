---
description: "House design language for BlueStep dashboard merge reports — exact tokens (palette, type, cards, tabs). Use this for ALL new BlueStep dashboard UI; do NOT use Material/rounded-tonal styling"
---

A consistent house style for BlueStep dashboard merge reports. Match it for any
new dashboard/merge-report UI. **Not Material** — it
explicitly rejects the Material 3 look (nav rail, FAB, chunky tonal containers,
