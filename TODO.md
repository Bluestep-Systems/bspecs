...
> **Both items below are now tracked upstream in [`Bluestep-Systems/web#1005`](https://github.com/Bluestep-Systems/web/issues/1005)** (platform MCP authoring gaps), consolidated with the feedback issues bspecs#32 / bspecs#29. These are server-side, not bspecs fixes — keep here only as pointers until web#1005 resolves.
