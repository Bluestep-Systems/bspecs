...
**Auto-run `npm install` in the scaffolded project — best-effort, with a fallback.**
...
The independent improvement shipped earlier: best-effort `npm install` in `scaffold.js`
(0.8.0).
